...
INSERT INTO `cat_impresoras` VALUES (1,28,10,10,10,10),(2,29,20,20,20,20),(3,30,30,15,15,15),(4,42,15,3,2,4);
...
INSERT INTO `tbl_carrito` VALUES (10,1,'2025-07-01 16:22:27'),(11,3,'2025-07-02 05:49:21'),(12,9,'2025-07-03 02:28:46');
...
INSERT INTO `tbl_carritodetalle` VALUES (43,10,34,2,'pendiente');
...
INSERT INTO `tbl_clientes` VALUES (1001,'Diego','31766316','HHHHHHHHHHHHHH9','0424-532-9515','alguien@gmail.com',1);
...
INSERT INTO `tbl_cuentas` VALUES (1,'BNC','1247862','143123423442','24141243241','EJEMPLO@GMAIL.COM','habilitado'),(8,'Banesco','1234567890','0123456789','0990812808','ejemplo@gmail.com','habilitado'),(9,'Bancamiga','1234567890','0123456789','0990812808','ejemplo@gmail.com68','habilitado'),(10,'Venezuela','87654321','0123456789','04141580151','ejemplo@gmail.com','habilitado'),(11,'Venezuela','0102-1234-12-3442244224','J-22332626-4','0414-158-0151','ejemplo@gmail.com','habilitado');
...
INSERT INTO `tbl_despacho_detalle` VALUES (2,3,32,1),(4,4,33,1),(7,5,34,3),(8,6,37,2);
...
INSERT INTO `tbl_despachos` VALUES (3,1001,'2025-07-01','0006',NULL),(4,1001,'2025-07-01','0002',NULL),(5,1001,'2025-07-01','1111',NULL),(6,1001,'2025-07-01','1234',NULL);
...
INSERT INTO `tbl_detalle_recepcion_productos` VALUES (11,10,30,1,4),(12,11,33,13,4);
...
INSERT INTO `tbl_factura_detalle` VALUES (21,36,34,3);
...
INSERT INTO `tbl_facturas` VALUES (36,'2025-07-02',1001,0,'Borrador');
...
INSERT INTO `tbl_ingresos_egresos` VALUES (8,3,NULL,'ingreso',8.00,'Venta: Tinta Arcoiris (x1)','2025-07-01',1),(9,3,NULL,'egreso',8.00,'Venta: Tinta Arcoiris (x1)','2025-07-01',1),(11,NULL,11,'egreso',4.00,'Compra: Impresora KING (x4)','2025-07-01',1),(14,4,NULL,'ingreso',12.00,'Venta: ImpriColor (x1)','2025-07-01',1),(15,5,NULL,'ingreso',360.00,'Venta: Caja de Color (x3)','2025-07-01',1),(16,6,NULL,'ingreso',120.00,'Venta: GigaVoltio (x2)','2025-07-01',1);
...
INSERT INTO `tbl_marcas` VALUES (1,'Epson Prime'),(2,'HP'),(3,'Canon'),(4,'Inktec'),(5,'TexPrint'),(6,'Sawgrass'),(7,'Cosmos Ink'),(8,'Azon'),(9,'Sublimagic'),(10,'Brother'),(11,'Forza'),(12,'Tripp Lite'),(13,'CDP'),(14,'Koblenz'),(15,'Epson'),(16,'HP'),(17,'Canon'),(18,'Inktec'),(19,'TexPrint'),(20,'Sawgrass'),(21,'Cosmos Ink'),(22,'Azon'),(23,'Sublimagic'),(24,'Brother'),(25,'Forza'),(26,'Tripp Lite'),(27,'CDP'),(28,'Koblenz'),(29,'Pokemon'),(30,'Digimon'),(31,'Bakugan');
...
INSERT INTO `tbl_orden_despachos` VALUES (0,36,'2025-07-02','0006',1);
...
INSERT INTO `tbl_productos` VALUES (28,'0001','Impresora Super','Impresora multifuncional con función wifi',6,11,50,10,100,'Garantia Valida hasta los 3 meses ',1000.00,'habilitado'),(29,'0002','Impresora Maxi','Impresora de Punta de fibra de vidrio para oficina',37,11,50,10,100,'Garantía para 1 mes',1500.00,'habilitado'),(30,'0003','Impresora KING','Impresora de Escáner Laser de Ultima Generación',34,11,50,10,100,'Garantía valida en los primeros 365 días',2000.00,'habilitado'),(31,'0004','Colormedia','Tintas multicolor para Impresoras Epson',16,12,20,10,50,'Sin Garantía',10.00,'habilitado'),(32,'0005','Tinta Arcoiris','Tintas de multi color duraderas para impresoras',23,12,20,5,50,'Sin Garantía',8.00,'habilitado'),(33,'0006','ImpriColor','Tintas Profesionales de 4 colores',26,12,30,10,70,'Sin Garantía',12.00,'habilitado'),(34,'0007','Caja de Color','Cartuchos de Tintas para Impresion',8,13,10,5,20,'Garantía de 1 mes de duración',120.00,'habilitado'),(35,'0008','ColorBox','Cartuchos de Tinta Profesional tamaño XL',49,13,7,5,20,'Garantía de 1 mes de duración',100.00,'habilitado'),(36,'0009','Colors Pandora','Cartuchos de Tinta Para Impresoras HP',9,13,10,5,25,'Garantía de 1 mes de duración',130.00,'habilitado'),(37,'0010','GigaVoltio','Protector de Voltaje para uso domestico',50,14,12,10,40,'Garantía de 1 mes de duración',60.00,'habilitado'),(38,'0011','ProtecVoltorb','Protector de Voltaje para Neveras',76,14,16,5,20,'Garantía de 1 mes de duración',25.00,'habilitado'),(39,'0012','ThunderBolt','Protector de Voltaje de uso Empresarial',52,14,7,3,15,'Garantía de 1 mes de duración',250.00,'habilitado'),(40,'0013','Clips de papel','Clips para actividades académicas',31,15,20,10,100,'Garantía de 1 mes de duración',5.00,'habilitado'),(41,'0014','Rema de Papel ','Rema de papel de oficina con 200 hojas blancas ',38,15,15,5,50,'Sin Garantia',3.00,'habilitado'),(42,'615179','Impresora XLC','ULtima generacion',16,11,1,5,20,'Garantia de 3 meses',120.00,'habilitado');
...
INSERT INTO `tbl_recepcion_productos` VALUES (10,1,'2025-07-01','0002'),(11,1,'2025-07-01','0006');
...
-- Dump completed on 2025-07-03  8:51:48
