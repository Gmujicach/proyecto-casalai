...
<p>
    En el <strong>lado superior derecho</strong> encontrara el boton <strong>Nuevo <?= $nombre_singular ?>.</strong>
</p>

<p><?= renderImagen($id, "combos-crear.png") ?></p>

<p>Al hacer <strong>clic</strong> lo llevara a la <strong>siguiente vista</strong>:</p>

<p><?= renderImagen($id, "incluir-combo-modal.png") ?></p>
...
<ul>
    <li>Presione el boton <strong>Guardar Combo</strong> para completar el registro.</li>
    <li>En caso de cometer un error puede presionar el boton <strong>Cancelar</strong> para vaciar todos los
        campos.
    </li>
</ul>
