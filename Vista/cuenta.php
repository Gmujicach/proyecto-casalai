                        ...
                        <div class="modal-body">
                            ...
                            <div class="grupo-form">
                                ...
                                <div class="grupo-interno">
                                    ...
                                    <input type="text" placeholder="N° cuenta" class="control-form" id="numero_cuenta"
                            ...
                            <div class="envolver-form">
                                ...
                                <div class="grupo-interno">
                                    <label class="label-checkbox">Métodos de Pago Aceptados</label>
                                    <div class="checkbox-container">
                                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                            <input type="checkbox" class="btn-check" value="Pago Movil" id="pagoMovil" name="metodos_pago[]"
                                                autocomplete="off">
                                            <label class="btn btn-outline-primary" for="pagoMovil">Pago Movil</label>

                                            <input type="checkbox" class="btn-check" id="transferencia" value="Transferencia"
                                                name="metodos_pago[]" autocomplete="off">
                    ...
                    <?php foreach ($cuentabancos as $cuenta): ?>
                        <tr data-id="<?php echo $cuenta['id_cuenta']; ?>">
                            <td>
                                <ul>
                                    <div>
                                        <button class="btn-modificar" id="btnModificarCuenta"
                                            ...
                                            data-metodos="<?php echo htmlspecialchars($cuenta['metodos']); ?>">Modificar</button>
                                    </div>
                                    <div>
                                        <button class="btn-eliminar"
                                            data-id="<?php echo $cuenta['id_cuenta']; ?>">Eliminar</button>
                                    </div>
                                </ul>
                            </td>
                            <td>
                            ...
                            <td>
                                <span
                                    ...
                                    data-id="<?php echo $cuenta['id_cuenta']; ?>" style="cursor: pointer;">
                    ...
                    <form id="modificarCuenta" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="grupo-interno">
                                ...
                                <div class="checkbox-container">
                                    <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                        <input type="checkbox" class="btn-check" id="ModificarpagoMovil" value="Pago Movil" name="metodos_pago[]"
                                            autocomplete="off">
                                        <label class="btn btn-outline-primary" for="ModificarpagoMovil">Pago Movil</label>

                                        <input type="checkbox" class="btn-check" id="Modificartransferencia" value="Transferencia" name="metodos_pago[]"
                                            autocomplete="off">
                                        <label class="btn btn-outline-primary" for="Modificartransferencia">Transferencia</label>
...
$(document).ready(function() {
    ...
    $('#registrarCuenta').on('submit', function(e) {
        ...
        for (let [key, value] of formData.entries()) {
            // Para los checkboxes (array)
            if (key === 'metodos_pago[]') {
                if (!data['metodos_pago']) {
                    data['metodos_pago'] = [];
                }
                data['metodos_pago'].push(value);
            } else {
                data[key] = value;
            }
        }
        ...
        const message = `Datos a enviar:\n\n` +
                        `Nombre Banco: ${data.nombre_banco}\n` +
                        `Número Cuenta: ${data.numero_cuenta}\n` +
                        `RIF: ${data.rif_cuenta}\n` +
                        `Teléfono: ${data.telefono_cuenta}\n` +
                        `Correo: ${data.correo_cuenta}\n` +
                        `Métodos Pago: ${data.metodos_pago ? data.metodos_pago.join(', ') : 'Ninguno'}`;
    ...
    // Interceptar el envío del formulario de modificación
    $('#modificarCuenta').on('submit', function(e) {
        ...
        // Mostrar los datos en un alert
        const message = `Datos a enviar (Modificación):\n\n` +
                        `ID Cuenta: ${data.id_cuenta}\n` +
                        `Nombre Banco: ${data.nombre_banco}\n` +
                        `Número Cuenta: ${data.numero_cuenta}\n` +
                        `RIF: ${data.rif_cuenta}\n` +
                        `Teléfono: ${data.telefono_cuenta}\n` +
