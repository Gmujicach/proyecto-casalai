...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-03-2025 a las 00:49:56
...
(53, '2025-03-21', 3, 'Borrador'),
(54, '2025-03-21', 3, 'Borrador'),
(55, '2025-03-21', 3, 'Borrador'),
(56, '2025-03-23', 3, 'Borrador');
...
--
-- Estructura de tabla para la tabla `tbl_detalles_combo`
--

CREATE TABLE `tbl_detalles_combo` (
...
(7, 3, 'Phasdsa', '12', 30.00, 12, 4, 21, 12, 5.00, 16.00, 0.00, 45.00, 0, 1233, 0, 0, '0', 1, '123231'),
...
(13, 'Braynt', '061299', 'almacen', NULL, NULL, NULL, NULL);
...
--
-- Indices de la tabla `tbl_detalles_combo`
--
ALTER TABLE `tbl_detalles_combo`
...
--
-- AUTO_INCREMENT de la tabla `tbl_detalles_combo`
--
ALTER TABLE `tbl_detalles_combo`
...
--
-- Filtros para la tabla `tbl_detalles_combo`
--
ALTER TABLE `tbl_detalles_combo`
  ADD CONSTRAINT `tbl_detalles_combo_ibfk_1` FOREIGN KEY (`id_combo`) REFERENCES `tbl_combo` (`id_combo`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_detalles_combo_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `tbl_productos` (`id_producto`) ON DELETE CASCADE;

--
-- Filtros para la tabla `tbl_detalles_pago`
--
ALTER TABLE `tbl_detalles_pago`
  ADD CONSTRAINT `tbl_detalles_pago` FOREIGN KEY (`id_cuenta`) REFERENCES `tbl_cuentas` (`id_cuenta`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_detalles_pago_ibfk_1` FOREIGN KEY (`id_factura`) REFERENCES `facturas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_detalles_pago_ibfk_2` FOREIGN KEY (`id_cuenta`) REFERENCES `tbl_cuentas` (`id_cuenta`) ON DELETE CASCADE ON UPDATE CASCADE;
