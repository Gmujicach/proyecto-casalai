...
class Finanza {
    ...
    // Getters y setters
    public function getIdFinanzas() { return $this->id_finanzas; }
    public function setIdFinanzas($id) { $this->id_finanzas = $id; }
    ...
    public function getIdDespacho() { return $this->id_despacho; }
    public function setIdDespacho($id) { $this->id_despacho = $id; }

    public function getIdRecepcion() { return $this->id_recepcion; }
    public function setIdRecepcion($id) { $this->id_recepcion = $id; }
    ...
    // ANULAR
    public function anular($id_finanzas) {
